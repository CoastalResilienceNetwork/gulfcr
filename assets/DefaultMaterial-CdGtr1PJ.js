const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-DJj-rub2.js","assets/index-D8e5E-9j.js","assets/index-CAYUSYQk.css","assets/IntersectorInterfaces-CmNINbyF.js","assets/boundedPlane-CteQNfkf.js","assets/lineSegment-DceUgSax.js","assets/Geometry-CxKoDyGg.js","assets/renderState-kw9QimUN.js","assets/basicInterfaces-CZwQPxTp.js","assets/ShaderOutput-DnYY5J1_.js","assets/BindType-BBwFZqyN.js","assets/glsl-BH37Aalp.js","assets/VertexAttribute-Cq4MnHjR.js","assets/orientedBoundingBox-C7ZCPflm.js","assets/spatialReferenceEllipsoidUtils-Cwi2QMXp.js","assets/computeTranslationToOriginAndRotation-Da71Qg43.js","assets/requestImageUtils-C-YrjxUe.js","assets/TextureFormat-1mYWTFa-.js","assets/InterleavedLayout-CZzog6na.js","assets/BufferView-GzedLDJw.js","assets/types-D0PSWh4d.js","assets/Indices-5nI-LpZY.js","assets/triangle-CANUhArD.js","assets/ShaderBuilder-BKwMEJaT.js","assets/NormalAttribute.glsl-Cm8HIODZ.js"])))=>i.map(i=>d[i]);
import{kC as $e,kw as Ee,mO as ta,mG as Q,cD as oa,mF as Oe,kP as je,kB as Aa,cx as U,a2 as E,pC as Ia,w1 as q,_ as me,c8 as ra,nt as ne,ac as s,ad as xe,ae as Ga,gD as oe,h9 as La,hd as Ve,hg as Ra,he as Fa,e_ as Pa,kp as Da,ok as ja,oy as Va,cM as Ba,q$ as O,ea as Ha,mu as Wa,t5 as Ua,oD as Be,mS as He,aw as qa,a4 as Ya,aG as ka,cu as be,ck as Za,cr as We,cj as Xa,kF as Ja}from"./index-D8e5E-9j.js";import{H as Ka}from"./InterleavedLayout-CZzog6na.js";import{n as g,u as ee,t as Ue,o as Te,r as Qa}from"./ShaderOutput-DnYY5J1_.js";import{n as _,a as T,t as he}from"./NormalAttribute.glsl-Cm8HIODZ.js";import{F as et,r as at,u as G,v as tt,x as ot,y as rt,z as se,p as it,B as nt,l as st,b as I,C as F,a as j,D as V,E as B,G as K,H as N,I as H,J as lt,K as ct,L as dt,M as P,P as ut,Q as ia,R as na,S as sa,T as la,U as mt,V as ze,W as fe,X as ca,Y as ht,e as le,Z as ft,_ as pt,$ as we,a0 as re,i as da,o as $,a1 as h,a2 as _e,a3 as Ne,a4 as ce,h as vt,a5 as gt,a6 as xt,a7 as ua,a8 as bt,a9 as Tt,aa as ma,ab as ha,d as de,ac as fa,ad as pa,ae as va,af as ga,ag as xa,ah as ue,ai as ba,aj as wt,ak as qe,al as Mt,am as yt,an as St,ao as Ct,ap as Nt,aq as $t,ar as Et,as as Ot,at as zt,au as R,av as d,aw as _t,A as Me,ax as At,ay as It,az as Gt,aA as Lt,aB as Rt,aC as Ft,aD as Pt}from"./Geometry-CxKoDyGg.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{i as A,a as Ye,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{o as Dt,r as jt}from"./doublePrecisionUtils-B0owpBza.js";import{a as Ae}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-BKwMEJaT.js";import{B as Ie,g as Ge,f as Vt}from"./renderState-kw9QimUN.js";function Bt(a){a.vertex.code.add(r`
...
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:Ee(e.normalType);case T.COUNT:}}let Ht=class extends et{constructor(){super(...arguments),this.transformNormalViewFromGlobal=$e()}},Wt=class extends tt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=$e(),this.toMapSpace=ta()}};function Yo({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||oa(n,Oe))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Ut=Q(1,1,.5),ko=Q(0,.6,.2),Zo=Q(0,1,.2);function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return posClip;
}`)}const ke=$e();function Ma(a,e){const t=e.hasModelTransformation,o=e.instancedDoublePrecision;t&&(a.vertex.uniforms.add(new ot("model",n=>n.modelTransformation??je)),a.vertex.uniforms.add(new G("normalLocalOriginFromModel",n=>(Aa(ke,n.modelTransformation??je),ke)))),e.instanced&&o&&(a.attributes.add(b.INSTANCEMODELORIGINHI,"vec3"),a.attributes.add(b.INSTANCEMODELORIGINLO,"vec3"),a.attributes.add(b.INSTANCEMODEL,"mat3"),a.attributes.add(b.INSTANCEMODELNORMAL,"mat3"));const i=a.vertex;o&&(i.include(rt,e),i.uniforms.add(new se("viewOriginHi",n=>Dt(U(ie,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ie)),new se("viewOriginLo",n=>jt(U(ie,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ie)))),i.code.add(r`
...
}`)}}function W(a,e){Yt(a,e,new I("textureAlphaCutoff",t=>t.textureAlphaCutoff))}function Yt(a,e,t){const o=a.fragment,i=e.alphaDiscardMode,n=i===A.Blend;i!==A.Mask&&i!==A.MaskBlend||o.uniforms.add(t),o.code.add(r`
...
}`),e.textureCoordinateType!==P.None&&(a.include(ut,e),t.uniforms.add(e.bindType===Ae.Pass?new N("normalTexture",o=>o.textureNormal):new ia("normalTexture",o=>o.textureNormal)),e.hasNormalTextureTransform&&(t.uniforms.add(new na("scale",o=>o.scale??Ia)),t.uniforms.add(new G("normalTextureTransformMatrix",o=>o.normalTextureTransformMatrix??q))),t.code.add(r`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}const Xt=3e5,Ze=5e5,ye=4;function Jt(){const a=new ve,e=a.fragment;a.include(sa);const t=(ye+1)/2,o=1/(2*t*t);return e.include(la),e.uniforms.add(new N("depthMap",i=>i.depthTexture),new ia("tex",i=>i.colorTexture),new mt("blurSize",i=>i.blurSize),new I("projScale",(i,n)=>{const c=n.camera.distance;return c>5e4?Math.max(0,i.projScale-(c-5e4)):i.projScale})),e.code.add(r`
...
}`),e.uniforms.add(new N("normalMap",t=>t.normalTexture),new N("depthMap",t=>t.depthTexture),new I("projScale",t=>t.projScale),new N("rnm",t=>t.noiseTexture),new na("rnmScale",(t,o)=>ne(Ke,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new I("intensity",t=>t.intensity),new ft("screenSize",t=>ne(Ke,t.camera.fullWidth,t.camera.fullHeight))),a.outputs.add("fragOcclusion","float"),e.main.add(r`
...
}`)}function Fe(a,e){const t=a.fragment.code;a.include(_e),e.pbrMode!==h.Normal&&e.pbrMode!==h.Schematic&&e.pbrMode!==h.Simplified&&e.pbrMode!==h.TerrainWithWater||(t.add(r`float normalDistribution(float NdotH, float roughness)
{
...
}`)}function Pe(a){a.constants.add("ambientBoostFactor","float",xt)}function De(a){a.uniforms.add(new le("lightingGlobalFactor",e=>e.lighting.globalFactor))}function Na(a,e){const t=a.fragment;switch(a.include(Re,e),e.pbrMode!==h.Disabled&&a.include(Fe,e),a.include(so,e),a.include(_e),t.code.add(r`
